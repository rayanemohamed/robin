...
const GUILDID = '702268409047679099'; //  تعديل مهم ايدي السيرفر  
const CHANNELID = '748031097304121446'; // تعديل مهم ايدي الروم الصوتي

//البرفكس
const prefix = "ds!"; // تعديل مهم حط هنا البرفكس او مقدمة الامر
...
client.on('ready', () => {
    client.user.setActivity(`Type d!help`,{ type: 'PLAYING' });
})


//تغير الحالة
const developers = ["687458493124444170","","",""] ///تعديل مهم حط هنا ايدي اللي بدك يتحكمو بالحالة
client.on('message', message => {
    ...
    if (message.content.startsWith(prefix + 'setStreaming')) {
      ...
      message.delete();
      client.user.setGame(argresult, 'https://www.twitch.tv/rayane_tv');
...
const youtube = new YouTube("AIzaSyBSXVUqsl0_xdEaT85tV93WxZDAHfcK-zI"); 
